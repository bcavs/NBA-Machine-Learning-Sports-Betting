...
def xgb_runner(
    ...
    for game in games:
        ...
        bankroll_fraction_home = bankroll_fraction_away = bankroll_descriptor + "0%"
        if home_team_odds[count] and away_team_odds[count]:
            ...
            bankroll_fraction_home = (
                bankroll_descriptor
                + str(
                    kc.calculate_kelly_criterion(
                        int(home_team_odds[count]), ml_predictions_array[count][0][1]
                    )
                )
                + "%"
            )
            bankroll_fraction_away = (
                ...
                + str(
                    kc.calculate_kelly_criterion(
                        int(away_team_odds[count]), ml_predictions_array[count][0][1]
                    )
                )
                + "%"
            )
